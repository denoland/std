...
export const EXTRACT_YAML_REGEXP = new RegExp(
  `^${BOM}${YAML_HEADER}${WHITESPACES}${NEWLINE}${WHITESPACES}${DATA}${WHITESPACES}${NEWLINE}${YAML_FOOTER}${WHITESPACES}${NEWLINE}?${BODY}$`,
  "is",
);
export const EXTRACT_TOML_REGEXP = new RegExp(
  `^${BOM}${TOML_HEADER}${WHITESPACES}${NEWLINE}${WHITESPACES}${DATA}${WHITESPACES}${NEWLINE}${TOML_FOOTER}${WHITESPACES}${NEWLINE}?${BODY}$`,
  "is",
);
export const EXTRACT_JSON_REGEXP = new RegExp(
  `^${BOM}${JSON_HEADER}${WHITESPACES}${NEWLINE}${WHITESPACES}${DATA}${WHITESPACES}${NEWLINE}${JSON_FOOTER}${WHITESPACES}${NEWLINE}?${BODY}$`,
  "is",
);
