...
/** @deprecated (will be removed in 0.157.0) This function has been moved to `/streams/conversion.ts`. */
...
/** @deprecated (will be removed in 0.157.0) This interface has been moved to `/streams/conversion.ts`. */
