...
/**
 * @deprecated (will be removed after 0.170.0) Import from `std/io/copy_reader.ts` instead
 *
...
/**
 * @deprecated (will be removed after 0.170.0) Import from `std/io/read_short.ts` instead
 *
...
/**
 * @deprecated (will be removed after 0.170.0) Import from `std/io/read_int.ts` instead
 *
...
/**
 * @deprecated (will be removed after 0.170.0) Import from `std/io/read_long.ts` instead
 *
...
/**
 * @deprecated (will be removed after 0.170.0) Import from `std/io/slice_long_to_bytes.ts` instead
 *
