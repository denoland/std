...
>
type JSONType<T extends string, IsPartial extends boolean> = IsPartial extends
  true ? T | undefined : T
...
type UncheckedJSONSchemaType<T, IsPartial extends boolean> =
  & ( // these two unions allow arbitrary unions of types
    ...
    | (
      & {
        type:
          readonly (T extends number ? JSONType<'number' | 'integer', IsPartial>
            : T extends string ? JSONType<'string', IsPartial>
            : T extends boolean ? JSONType<'boolean', IsPartial>
            : never)[]
      }
      & UnionToIntersection<
        T extends number ? NumberKeywords
          : T extends string ? StringKeywords
          : T extends boolean ? {}
          : never
      >
    )
      ...
      & (T extends number ? {
              ...
              items:
                & {
                  readonly [K in keyof T]-?:
                    & UncheckedJSONSchemaType<T[K], false>
                    & Nullable<T[K]>
                }
                & {
                  length: T['length']
        ...
        : T extends Record<string, any> ?
            & {
              ...
              >
              propertyNames?:
                & Omit<UncheckedJSONSchemaType<string, false>, 'type'>
                & {
                  type?: 'string'
                }
              dependencies?: {
