...
Deno.test("Handler handles default setup", function () {
...
Deno.test("Handler handles formatter with empty msg", function () {
...
Deno.test("Handler handles formatter", function () {
  const handler = new TestHandler("DEBUG", {
