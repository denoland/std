...
// $ deno install catjson https://deno.land/std/examples/catjson.ts
...
function printArray(array: unknown[], path: string): void {
  for (const index in array) {
    ...
    const nodePath = (path ? path : colors.cyan('.')) + '[' + colors.cyan(index) + ']';
...
async function main() {
  ...
  if (parsedArgs._.length === 0 || parsedArgs._[0] === "-") {
