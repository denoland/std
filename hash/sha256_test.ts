...
import { HmacSha256, Sha256 } from "./sha256.ts";
...
const fixtures: {
  ...
  sha256Hmac: {
    'Test Vectors': {
      ...
      '5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843': ['Jefe', 'what do ya want for nothing?'],
  ...
  sha224Hmac: {
    'Test Vectors': {
      ...
      a30e01098bc6dbbf45690f3a7e9e6d0f8bbea2a39e6148008fd05e44: ['Jefe', 'what do ya want for nothing?'],
...
fixtures.sha256.Uint8Array = {
  ...
  d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592: new Uint8Array([
    84, 104, 101, 32, 113, 117, 105, 99, 107, 32, 98, 114, 111, 119, 110, 32, 102, 111, 120, 32, 106, 117, 109, 112,
    115, 32, 111, 118, 101, 114, 32, 116, 104, 101, 32, 108, 97, 122, 121, 32, 100, 111, 103
  ])
}
...
fixtures.sha256.Int8Array = {
  d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592: new Int8Array([
    84, 104, 101, 32, 113, 117, 105, 99, 107, 32, 98, 114, 111, 119, 110, 32, 102, 111, 120, 32, 106, 117, 109, 112,
    115, 32, 111, 118, 101, 114, 32, 116, 104, 101, 32, 108, 97, 122, 121, 32, 100, 111, 103
  ])
}
