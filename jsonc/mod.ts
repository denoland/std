...
/**
 * Converts a
 * {@link https://code.visualstudio.com/docs/languages/json#_json-with-comments | JSON with comments(JSONC)}
 * string into an object. If a syntax error is found, throw a {@linkcode SyntaxError}.
 *
 * @example Usage
 * ```ts
 * import { parse } from "@std/jsonc";
