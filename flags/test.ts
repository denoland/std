...
Deno.test("typesOfAllBooleanDisabledAndStringArgs", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        foo?: string | false | Array<string | false> | undefined;
        _: Array<string | number>;
      }
    >
  >(true);
...
Deno.test("typesOfAllBooleanDisabledAndStringArgsWithDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        foo: string | false | number | Array<string | false>;
        bar: unknown;
        _: Array<string | number>;
      }
    >
...
Deno.test("typesOfAllBoolean", function (): void {
  ...
  assertType<
    IsExact<
      typeof argv,
      & { [x: string]: boolean | Array<boolean> | undefined }
      & {
        _: Array<string | number>;
      }
    >
...
Deno.test("typesOfAllBooleanAndStringArgs", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & {
        foo?: string | false | Array<string | false> | undefined;
        bar?: string | false | Array<string | false> | undefined;
        "foo-bar"?: string | false | Array<string | false> | undefined;
        _: Array<string | number>;
      }
    >
  >(true);
...
Deno.test("typesOfAllBooleanAndStringArgsWithDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & {
        foo?: string | false | Array<string | false> | undefined;
        bar: string | false | Array<string | false> | number;
        baz: unknown;
        "foo-bar"?: string | false | Array<string | false> | undefined;
        _: Array<string | number>;
      }
...
Deno.test("typesOfBooleanArgs", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        foo: boolean | Array<boolean>;
        bar: boolean | Array<boolean>;
        "foo-bar": boolean | Array<boolean>;
        _: Array<string | number>;
      }
    >
  >(true);
...
Deno.test("typesOfBooleanArgsWithDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & {
        foo: boolean | Array<boolean>;
        bar: number | boolean | Array<boolean>;
        baz: unknown;
        "foo-bar": boolean | Array<boolean>;
        _: Array<string | number>;
      }
...
Deno.test("typesOfStringArgsWithDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & {
        foo?: string | false | Array<string | false> | undefined;
        bar: string | boolean | Array<string | false>;
        baz: unknown;
        "foo-bar"?: string | false | Array<string | false> | undefined;
        _: Array<string | number>;
      }
...
Deno.test("typesOfBooleanAndStringArgs", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        beep?: string | false | Array<string | false> | undefined;
        boop?: string | false | Array<string | false> | undefined;
        "beep-boop"?: string | false | Array<string | false> | undefined;
        foo: boolean | Array<boolean>;
        bar: boolean | Array<boolean>;
        "foo-bar": boolean | Array<boolean>;
        _: Array<string | number>;
  ...
  assertType<
    IsExact<
      ...
      & {
        ...
        bar: number | boolean | Array<boolean>;
        baz: unknown;
        beep: string | false | Array<string | false> | Date;
        "foo-bar": boolean | Array<boolean>;
        _: Array<string | number>;
      }
    >
...
Deno.test("typesOfDottedBooleanArgs", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        blubb: boolean | Array<boolean>;
        foo: {
          bar: boolean | Array<boolean>;
          baz: {
            biz: boolean | Array<boolean>;
            buz: boolean | Array<boolean>;
          };
        };
        _: Array<string | number>;
      }
...
Deno.test("typesOfDottedBooleanArgsWithDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        blubb: boolean | string | Array<boolean>;
        foo: {
          bar: boolean | number | Array<boolean>;
          baz: {
            biz: boolean | Array<boolean> | Date;
            buz: boolean | Array<boolean>;
          };
        };
        bla: unknown;
...
Deno.test("typesOfDottedStringArgs", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        blubb?: string | false | Array<string | false> | undefined;
        foo?: {
          bar?: string | false | Array<string | false> | undefined;
          baz?: {
            biz?: string | false | Array<string | false> | undefined;
            buz?: string | false | Array<string | false> | undefined;
          };
        };
        _: Array<string | number>;
      }
...
Deno.test("typesOfDottedStringArgsWithDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        blubb: string | boolean | Array<string | false>;
        foo: {
          bar: string | false | number | Array<string | false>;
          baz: {
            biz: string | false | Date | Array<string | false>;
            buz?: string | false | Array<string | false> | undefined;
          };
        };
        bla: unknown;
  ...
  assertType<
    IsExact<
      ...
      & {
        ...
        bla?: string | false | Array<string | false> | undefined;
        beep: {
          boop?: string | false | Array<string | false> | undefined;
          bib: {
            bab?: string | false | Array<string | false> | undefined;
            bub: boolean | Array<boolean>;
          };
        };
        _: Array<string | number>;
      }
    ...
    IsExact<
      ...
      & {
        ...
        foo: {
          bar: boolean | number | Array<boolean>;
          baz: {
            biz: boolean | Date | Array<boolean>;
            buz?: string | false | Array<string | false> | undefined;
          };
        };
        beep: {
          boop: string | boolean | Array<string | false>;
          bib: {
            bab: string | false | Date | Array<string | false>;
            bub: boolean | Array<boolean>;
          };
        };
        _: Array<string | number>;
  ...
  assertType<
    IsExact<
      ...
      & {
        foo: number | {
          bar?: {
            baz?: string | false | Array<string | false> | undefined;
          } | undefined;
        };
        beep: Date | {
          boop: {
            bab: boolean | Array<boolean>;
          };
        };
        _: Array<string | number>;
      }
...
Deno.test("typesOfArgsWithDottedDefaults", function (): void {
  ...
  assertType<
    IsExact<
      ...
      & { [x: string]: unknown }
      & {
        foo: string | false | Array<string | false> | {
          bar: number;
        };
        _: Array<string | number>;
      }
  ...
  assertType<
    IsExact<
      ...
      & {
        foo?: string | false | Array<string | false> | undefined;
        bar: string | false | Array<string | false> | undefined;
        baz: string | false | Array<string | false> | null;
        _: Array<string | number>;
      }
    >
  >(true);
