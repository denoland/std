...
Deno.test("closestString() checks basic example", function () {
...
Deno.test("closestString() checks case sensitive example 1", function () {
  const words = ["hi", "hello", "help"];
...
Deno.test("closestString() checks case sensitive example 2", function () {
  const words = ["HI", "HELLO", "HELP"];
...
Deno.test("closestString() checks empty input", function () {
  assertThrows(
    () => closestString("he", []),
    Error,
