...
import type { ReleaseType } from "./mod.ts";
...
Deno.test("increment", async (t) => {
  ...
  const versions: [
    ...
    string?,
      ...
      ["1.2.3-alpha.0.beta", "prerelease", undefined, undefined, "1.2.3-alpha.1.beta"],
      ["1.2.3-alpha.1.beta", "prerelease", undefined, undefined, "1.2.3-alpha.2.beta"],
      ["1.2.3-alpha.2.beta", "prerelease", undefined, undefined, "1.2.3-alpha.3.beta"],
      ["1.2.3-alpha.10.0.beta", "prerelease", undefined, undefined, "1.2.3-alpha.10.1.beta"],
      ["1.2.3-alpha.10.1.beta", "prerelease", undefined, undefined, "1.2.3-alpha.10.2.beta"],
      ["1.2.3-alpha.10.2.beta", "prerelease", undefined, undefined, "1.2.3-alpha.10.3.beta"],
      ["1.2.3-alpha.10.beta.0", "prerelease", undefined, undefined, "1.2.3-alpha.10.beta.1"],
      ["1.2.3-alpha.10.beta.1", "prerelease", undefined, undefined, "1.2.3-alpha.10.beta.2"],
      ["1.2.3-alpha.10.beta.2", "prerelease", undefined, undefined, "1.2.3-alpha.10.beta.3"],
      ["1.2.3-alpha.9.beta", "prerelease", undefined, undefined, "1.2.3-alpha.10.beta"],
      ["1.2.3-alpha.10.beta", "prerelease", undefined, undefined, "1.2.3-alpha.11.beta"],
      ["1.2.3-alpha.11.beta", "prerelease", undefined, undefined, "1.2.3-alpha.12.beta"],
  ...
  for (const [original, op, identifier, metadata, expected] of versions) {
    await t.step({
      ...
      fn: () => {
        const version = semver.parse(original);
        const actual = semver.increment(version, op, identifier, metadata);
        assertEquals(semver.format(actual), expected);
      },
    });
  }
});
