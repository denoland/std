...
Deno.test({
  name: "invalid size or step: other than number",
  fn() {
...
Deno.test({
  name: "invalid size or step: not integer number",
  fn() {
    slidingWindowsThrowsTest(
      [[1, 2, 3, 4, 5], 0.5],
      RangeError,
...
Deno.test({
  name: "invalid size or step: not positive number",
  fn() {
    slidingWindowsThrowsTest(
      [[1, 2, 3, 4, 5], 0],
      RangeError,
...
Deno.test({
  name: "invalid size or step: infinity",
  fn() {
    slidingWindowsThrowsTest(
