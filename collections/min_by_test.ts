...
Deno.test("of array of input with mutation", () => {
  const input = [
    { name: "Kyle", age: 34 },
    { name: "John", age: 42 },
    { name: "Anna", age: 23 },
...
Deno.test("of array of input with multiple min", () => {
  const input = [
    { name: "Kyle", age: 34 },
    { name: "John", age: 42 },
    { name: "Anna", age: 23 },
...
Deno.test("of array of positive numbers", () => {
  const input = [2, 3, 5];
...
Deno.test("of array of negative numbers", () => {
  const input = [-2, -3, -5];
...
Deno.test("of array of numbers with multiple min", () => {
  const input = [2, 3, 5, 5];
...
Deno.test("of array of numbers with infinity", () => {
...
Deno.test("of array of numbers with NaN", () => {
