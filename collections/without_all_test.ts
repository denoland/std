...
Deno.test({
  name: "withoutAll() checks no mutation",
  fn() {
    const array = [1, 2, 3, 4];
...
Deno.test({
  name: "withoutAll() checks empty input",
  fn() {
    withoutAllTest([], [], []);
  },
});
...
Deno.test({
  name: "withoutAll() checks no matches",
  fn() {
...
Deno.test({
  name: "withoutAll() checks single match",
  fn() {
...
Deno.test({
  name: "withoutAll() checks multiple matches",
  fn() {
