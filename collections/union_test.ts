...
Deno.test({
  name: "union() checks no mutations",
  fn() {
    const arrayA = [1, 2, 3];
    const arrayB = [2, 4, 5];
    union(arrayA, arrayB);
...
Deno.test({
  name: "union() checks empty arrays",
  fn() {
    unionTest(
      [
        [],
...
Deno.test({
  name: "union() checks distinct sets",
  fn() {
...
Deno.test({
  name: "union() checks overlapping sets",
  fn() {
