...
export const anyDecoder = new Decoder(value => new DecoderSuccess(value));

export const stringPromiseDecoder = new PromiseDecoder(async value =>
  typeof value === "string"
    ? new DecoderSuccess(value)
    : [new DecoderError(value, "must be a string")]
);

export const booleanPromiseDecoder = new PromiseDecoder(async value =>
  typeof value === "boolean"
    ? new DecoderSuccess(value)
    : [new DecoderError(value, "must be a boolean")]
);

export const numberPromiseDecoder = new PromiseDecoder(async value =>
  typeof value === "number"
    ? new DecoderSuccess(value)
    : [new DecoderError(value, "must be a number")]
);
