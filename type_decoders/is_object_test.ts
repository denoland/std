...
test(function noOptions() {
  ...
  for (const item of [
    ...
    { string: 'fead', number: -123.21, boolean: true, child: { string: '', number: 100.32, boolean: false } },
  ...
  const obj2 = { string: 'fdaf', boolean: false, square: ['box'], number: '324' };
  assertDecodeErrors({
    decoder: decoder,
    input: obj2,
    expected: [
  ...
  const obj3 = { string: false, number: -123.21, boolean: 'true', child: { string: '', number: 100.32, boolean: false } };
  assertDecodeErrors({
    decoder: decoder,
    input: obj3,
    expected: [
...
test(function optionNoExcessProperties() {
  ...
  const objb = { string: 'fead', number: -123.21, boolean: true, child: { string: '', number: 100.32, boolean: false } };
  assertDecodeErrors({
    decoder: decoder,
    input: objb,
    expected: [
...
test(function nestedObject() {
  ...
  for (const item of [
    { string: 'ste', number: 23, boolean: true, child: {string: '', deno: Symbol('lang'), number: 2342343, boolean: false} },
    { string: 'feAd', number: -123.21, boolean: true, child: {string: 'fDFEDcd', number: -343.3434, nullable: null, boolean: true} },
    { string: '', number: 100.32, boolean: false, child: {string: 'f43df454', number: 23, boolean: true, square: ['box']} },
  ]) {
    // isObject returns a new object so we can't use the `expected` option
    assertDecodeSuccess(decoder, item);
    assertNotEquals(decoder.decode(item), new DecoderSuccess(item));
  ...
  const obja = { string: 'ste', numbr: 23, boolean: true, child: {strig: '', deno: Symbol('lang'), number: 2342343, boolean: false} };
  assertDecodeErrors({
    decoder: decoder,
    input: obja,
    expected: [
  ...
  const objb = { string: 'feAd', number: -123.21, boolean: true, child: {string: 'fDFEDcd', number: '-343.3434', boolean: true} };
  assertDecodeErrors({
    decoder: decoder,
    input: objb,
    expected: [
  ...
  const objc = { string: Symbol('f43df454'), number: 100.32, boolean: false, child: {string: Symbol('f43df454'), number: 23, boolean: {}, square: ['box']} };
  assertDecodeErrors({
    decoder: decoder,
    input: objc,
    expected: [
