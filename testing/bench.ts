 ...
 *
 * @deprecated (will be removed in 0.157.0) Use `Deno.bench()` instead.
 * @module
 */
...
/**
 * @deprecated (will be removed in 0.157.0) Use `Deno.bench()` instead. See https://doc.deno.land/deno/unstable/~/Deno.bench
 * for details.
 *
