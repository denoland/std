...
/** @deprecated (will be removed in 0.157.0) Use assertThrows(fn, msg) instead, which now returns thrown
...
/** @deprecated (will be removed in 0.157.0) Use assertRejects(fn, msg) instead, which now returns rejected value
