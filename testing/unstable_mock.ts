...
function functionSpy<Self, Args extends unknown[], Return>(
  ...
  defineSpyInternals(spy, { calls, original });
  return spy;
}
...
function constructorSpy<Self, Args extends unknown[]>(
  ...
  const spy = class extends original {
    ...
    constructor(...args: Args) {
      const call: SpyCall<Self, Args, Self> = { result: "returned", args };
      try {
        super(...args);
  ...
  defineSpyInternals(spy as never, { calls, original: original as never });
  return spy;
}
...
export function stub<Self, Args extends unknown[], Return>(
  ...
  defineSpyInternals(stub, { calls, original: original });
