...
Deno.test("test()", async (t) => {
  /**
   * Asserts that `Deno.test` is called with the correct options for the `test` call in the callback function.
   * This is used to reduce code duplication when testing calling `test` with different call signatures.
   */
  async function assertOptions<T>(
    expectedOptions: Omit<Deno.TestDefinition, "name" | "fn">,
    cb: (fn: Spy) => void,
  ...
  /**
   * Asserts that `Deno.test` is called with just the name and function for the `test` call in the callback function.
   * This is used to reduce code duplication when testing calling `test` with different call signatures.
   */
  async function assertMinimumOptions(
    cb: (fn: Spy) => void,
  ...
  /**
   * Asserts that `Deno.test` is called with all of the options for the `test` call in the callback function.
   * This is used to reduce code duplication when testing calling `test` with different call signatures.
   */
  async function assertAllOptions(
    cb: (fn: Spy) => void,
  ...
  await t.step("signature 1", async (t) => {
    await t.step(
      ...
      async () =>
        await assertMinimumOptions((fn) => {
          assertEquals(test({ name: "example", fn }), undefined);
        }),
    );
  ...
  await t.step("signature 2", async (t) => {
    await t.step(
      ...
      async () =>
        await assertMinimumOptions((fn) => {
          assertEquals(test("example", { fn }), undefined);
        }),
    );
  ...
  await t.step("signature 4", async () =>
    await assertMinimumOptions((fn) => {
      assertEquals(
        test(function example(this: void, ...args) {
          fn.apply(this, args);
        }),
        undefined,
      );
  ...
  await t.step("only", async (t) => {
    /**
     * Asserts that `Deno.test` is called with just the name, only, and function for the `test.only` call in the callback function.
     * This is used to reduce code duplication when testing calling `test.only` with different call signatures.
     */
    async function assertMinimumOptions(
      cb: (fn: Spy) => void,
    ) {
    ...
    /**
     * Asserts that `Deno.test` is called with all of the options for the `test.only` call in the callback function.
     * This is used to reduce code duplication when testing calling `test.only` with different call signatures.
     */
    async function assertAllOptions(
      cb: (fn: Spy) => void,
    ...
    await t.step("signature 1", async (t) => {
      await t.step(
        ...
        async () =>
          await assertMinimumOptions((fn) => {
            assertEquals(test.only({ name: "example", fn }), undefined);
          }),
      );
    ...
    await t.step("signature 2", async (t) => {
      await t.step(
        ...
        async () =>
          await assertMinimumOptions((fn) => {
            assertEquals(test.only("example", { fn }), undefined);
          }),
      );
    ...
    await t.step(
      ...
      async () =>
        await assertMinimumOptions((fn) => {
          assertEquals(
            test.only(function example(this: void, ...args) {
              fn.apply(this, args);
            }),
            undefined,
          );
  ...
  await t.step("ignore", async (t) => {
    /**
     * Asserts that `Deno.test` is called with just the name, ignore, and function for the `test.ignore` call in the callback function.
     * This is used to reduce code duplication when testing calling `test.ignore` with different call signatures.
     */
    async function assertMinimumOptions(
      cb: (fn: Spy) => void,
    ) {
    ...
    /**
     * Asserts that `Deno.test` is called with all of the options for the `test.ignore` call in the callback function.
     * This is used to reduce code duplication when testing calling `test.ignore` with different call signatures.
     */
    async function assertAllOptions(
      cb: (fn: Spy) => void,
    ...
    await t.step("signature 1", async (t) => {
      await t.step(
        ...
        async () =>
          await assertMinimumOptions((fn) => {
            assertEquals(test.ignore({ name: "example", fn }), undefined);
          }),
      );
    ...
    await t.step("signature 2", async (t) => {
      await t.step(
        ...
        async () =>
          await assertMinimumOptions((fn) => {
            assertEquals(test.ignore("example", { fn }), undefined);
          }),
      );
    ...
    await t.step(
      ...
      async () =>
        await assertMinimumOptions((fn) => {
          assertEquals(
            test.ignore(function example(this: void, ...args) {
              fn.apply(this, args);
            }),
            undefined,
          );
