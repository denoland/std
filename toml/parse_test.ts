...
Deno.test({
  ...
  fn() {
    ...
    assertEquals(parse("0xDEADBEEF"), 3735928559); // 0xDEADBEEF = 3735928559
    assertEquals(parse("0xdeadbeef"), 3735928559); // 0xdeadbeef = 3735928559
    assertEquals(parse("0xdead_beef"), 3735928559); // 0xdead_beef = 3735928559
    assertEquals(parse("0o01234567"), 342391); //  0o01234567 = 342391
    assertEquals(parse("0o755"), 493); // 0o755 = 493
    assertEquals(parse("0b11010110"), 214); // 0b11010110 = 214
    assertThrows(() => parse(""));
