...
import { crypto as wasmCrypto, DigestAlgorithm, digestAlgorithms } from '../_wasm_crypto/mod.ts'
...
export class Hash extends Transform {
  ...
  constructor(algorithm: string | wasmCrypto.DigestContext, _opts?: TransformOptions) {
    super({
    ...
    if (typeof algorithm === 'string') {
      ...
      this.#context = new wasmCrypto.DigestContext(algorithm as DigestAlgorithm)
    } else {
...
export default { Hash, createHash, getHashes, pbkdf2, pbkdf2Sync, randomBytes, scrypt, scryptSync }
