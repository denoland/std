...
// From https://github.com/indutny/elliptic/blob/master/dist/elliptic.js
  ...
  return (function () {
  ...
  })()(
    {
      ...
      3: [function (require, module, exports) {
        ...
        Point.prototype._projAdd = function _projAdd(p) {
          ...
          var tmp = this.x.redAdd(this.y).redMul(p.x.redAdd(p.y)).redISub(c)
            .redISub(d);
      ...
      6: [function (require, module, exports) {
        ...
        ShortCurve.prototype.pointFromX = function pointFromX(x, odd) {
          ...
          var y2 = x.redSqr().redMul(x).redIAdd(x.redMul(this.a)).redIAdd(
            this.b,
          );
          var y = y2.redSqrt();
          if (y.redSqr().redSub(y2).cmp(this.zero) !== 0) {
    ...
    */
          ...
          Mont.prototype.imul = function imul(a, b) {
            ...
            var t = a.imul(b);
            var c = t.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(
              this.m,
            );
      ...
      30: [function (require, module, exports) {
        ...
        function join32(msg, start, end, endian) {
          ...
          for (var i = 0, k = start; i < res.length; i++, k += 4) {
            var w;
            if (endian === "big") {
              w = (msg[k] << 24) | (msg[k + 1] << 16) | (msg[k + 2] << 8) |
                msg[k + 3];
            } else {
              w = (msg[k + 3] << 24) | (msg[k + 2] << 16) | (msg[k + 1] << 8) |
                msg[k];
            }
            res[i] = w >>> 0;
          }
